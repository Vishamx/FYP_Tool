...
dataset = pd.read_csv('audio_steganography_final_analysis.csv')  # Replace with your actual file path

# Step 2: Split the features and target
X = dataset[['Text Size (bits)', 'Embedding Capacity (kb)', 'Bps', 'SNR (dB)', 'MSE']]  # Features
y = dataset['Overall Quality']  # Target labels (good = 0, acceptable = 1, bad = 2)
...
joblib.dump(rf_model, 'audio_random_forest_model.joblib')
